...
const selectOptions = [
  ...
  { value: "7", label: "Filipino" },
  { value: "8", label: "Hindi" },
  { value: "9", label: "Japanese" },
  { value: "10", label: "Malay" },
];
...
const SelectBoxselect = React.forwardRef(
  (
    {
      children,
      placeholder = "Select",
